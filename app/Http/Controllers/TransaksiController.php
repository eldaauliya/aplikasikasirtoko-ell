...
class TransaksiController extends Controller
{
    public function index(Request $request)
    {
        ...
        ->leftJoin('users', 'penjualans.user_id', '=', 'users.id') // Join dengan tabel users untuk mendapatkan nama kasir
        ->select('penjualans.*', 'pelanggans.nama as nama_pelanggan', 'users.nama as nama_kasir') // Sertakan nama_kasir dari tabel users
