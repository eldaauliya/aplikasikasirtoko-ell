...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \App\Models\Pelanggan::create([
            ...
            'member' => true,
            'nomor_member' => 'MEM001',
            'tanggal_bergabung' => now()->subDays(30), // Contoh tanggal bergabung 30 hari yang lalu
            'point_reward' => 100, // Sesuaikan dengan kebutuhan Anda
        ...
        \App\Models\Pelanggan::create([
            ...
            'member' => true,
            'nomor_member' => 'MEM002',
            'tanggal_bergabung' => now()->subDays(15), // Contoh tanggal bergabung 15 hari yang lalu
            'point_reward' => 100, // Sesuaikan dengan kebutuhan Anda
        ]);
        ...
        \App\Models\Penjualan::create([
            ...
            'tunai'=>10000,
            'kembalian'=>650,
            'diskon' => 0, // Tambah kolom diskon di sini
        ]);
        \App\Models\Penjualan::create([
            'user_id'=>2,
            'pelanggan_id'=>2,
